...
function Loader({ show }) {
  return (
    // <dialog className="app-menu fixed overflow-hidden h-screen pointer-events-none opacity-1 z-100">
    // </dialog>
      <div className="relative z-20 w-full h-screen items-center block max-w-smx p-6 bg-white/40 dark:bg-slate-800/40 dark:border-slate-800 ">
    ...
    <p className="font-normal text-gray-700 dark:text-gray-400 opacity-20">Here are the biggest enterprise technology acquisitions of 2021 so far, in reverse chronological order.</p> */}
        <div
          role="status"
          className="absolute z-30 -translate-x-1/2 -translate-y-1/2 top-2/4 left-1/2"
        >
          <svg
            aria-hidden="true"
