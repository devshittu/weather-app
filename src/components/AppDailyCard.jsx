...
function AppDailyCard({ className }) {
  ...
  return (
    ...
    // >
    <article
      className={`max-w-md md:max-w-xl rounded-lg backdrop-blur bg-white/30 shadow-2xl bg-gradient-to-tr  ${className}`}
    >
      <div className="p-6 flex flex-col justify-start space-y-4">
        ...
        <div className="w-1/2 self-center ">
          ...
          <span className="text-2xl block text-center mt-4">Partly Cloudy</span>
        </div>
        <div className="flex">
