...
function AppDailyCard({ className }) {
    ...
    >
      <div className="p-3 md:p-6 flex flex-col justify-start space-y-4">
        <div className="flex justify-center md:justify-between items-center">
          ...
          <span className="px-4 py-1 border-2 hidden md:block border-white/20 text-emerald-500 text-l leading-tight rounded bg-white bg-opacity-5 hover:bg-black hover:bg-opacity-5 focus:outline-none focus:ring-0 transition duration-150 ease-in-out">
            18:45
          </span>
        </div>
        <div className="w-full flex flex-col md:flex-row">
          ...
          <span className="text-md md:text-2xl block text-center md:text-left mt-4 md:mt-0 md:ml-4 self-center shrink">
            Partly Cloudy
          </span>
        </div>
